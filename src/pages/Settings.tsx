...
import { DollarSign, Save, CheckCircle, Car, AlertTriangle, Trash2 } from 'lucide-react'
...
export default function Settings() {
  ...
  async function handleReset() {
    ...
    try {
      ...
      setError('Could not reset system. Please try again.')
      setResetting(false)
    }
  }
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="mt-12 pt-8 border-t border-red-100">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-6">
            <h3 className="font-semibold text-red-900 mb-1">Factory Reset System</h3>
            <p className="text-sm text-red-700 mb-4">
              This will irreversibly delete ALL drivers, agents, audit logs, and telegram messages. 
              Only use this when moving from testing to actual production. Your settings and admin account will be preserved.
            </p>
              ...
              <div className="bg-white p-4 rounded-lg border border-red-200 shadow-sm space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-slate-200 rounded text-sm font-mono focus:ring-2 focus:ring-red-500 focus:outline-none"
                  />
                  <button
                    type="button"
                    disabled={resetText !== 'RESET' || resetting}
                    onClick={handleReset}
                    className="px-4 py-2 bg-red-600 disabled:bg-red-300 hover:bg-red-700 text-white font-semibold rounded text-sm transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded text-sm transition-colors"
                  >
                    Cancel
                  </button>
                </div>
